...
:::: {.column width="40%"}
![views](views.png){fig-alt="HELM views last 30 days" }
![locations](locations.png){fig-alt="HELM locations last 30 days" }
::::

:::: {.column width="60%"}
![](topics.png){fig-alt="HELM topcs last 30 days" width="50%"}
::::
:::
